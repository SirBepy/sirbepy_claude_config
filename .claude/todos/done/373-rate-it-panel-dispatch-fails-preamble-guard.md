...
<!-- cleanup: last-checked 2026-08-19, complexity=HARD, worth=7, reconfirm-count=1, content-hash=de57ba2f -->
...
- 837b496: rate-it panel.md and autopilot dispatch templates now carry all three markers the dispatch guard requires. The hook itself was correct and left alone.
