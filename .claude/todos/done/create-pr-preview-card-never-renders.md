...
- Archived via mega-todos 2026-08-19. 2cca26d: create-pr step 4 now names the unresolved Conductor parser fact explicitly and gives both resolutions rather than guessing one. Settling the fact itself needs a live Conductor session.
