...
- b6cbce1: mtime liveness heuristic replaced with effect-based checks (git status scoped to owned paths, expected artifacts, TaskStop probe). Prose-only, hook untouched by design.
