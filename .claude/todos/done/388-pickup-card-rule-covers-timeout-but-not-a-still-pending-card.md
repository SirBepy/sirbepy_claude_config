...
- 153bfcd: pickup Step 4 gains a still-pending-card branch, distinct from the timeout branch which now names a real MCP idle-timeout error as its precondition.
