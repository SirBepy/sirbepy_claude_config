...
- 82e898a: PLAN.md id-prune regex widened to bold/backtick/[P] forms and the no-match branch now warns loudly. Reproduced live this run when archiving todo 30 left a bold line behind.
