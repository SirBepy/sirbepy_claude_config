...
- Done 2026-08-13. Part 1: the three archived duplicates of the commit-marker fix (ids 98, 263, and one id-less file) were deleted after recording the four-way filing in done/265; git history keeps them. Part 2: renumbered the later file of every remaining collision, earliest-filed keeps the id, evidence being the earliest date recorded inside each file. 13 -> 296, 99 -> 297, 100 -> 298, 249 -> 299, 287 -> 300, 288 -> 301, plus 293 -> 295 for a same-day collision with a todo filed from another project session. Each renamed file carries a Notes line naming its old id. Verified after: 206 files, zero colliding ids, highest id 301. Part 3 verdict: NO change needed. The Content-duplicate guard in ai-todos-format.md already reads 'grep the destination backlog and done/', so done/ is in scope today. The four-way duplicate predates that extension (todo 96, commit e6f2199, 2026-08-12) rather than proving a live gap.
