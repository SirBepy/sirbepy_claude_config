...
- 36073e6: hs_addtime.cjs wired into hubstaff.md with the hardcoded labels moved to the shared config source. NOT run against live HubStaff - the dev validates the first real run.
