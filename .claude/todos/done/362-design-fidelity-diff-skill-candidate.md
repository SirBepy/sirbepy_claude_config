...
- e5b0646: /test split into fast-checks-only plus a new /e2e skill, CLAUDE.md testing bullet reverted accordingly, and render-and-diff landed as a mode on /e2e. Dev decision taken live 2026-08-19, superseding the todo text and PLAN.md.
