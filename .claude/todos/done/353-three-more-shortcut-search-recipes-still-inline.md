...
- Related: [[343-shortcut-call-sites-still-hand-roll-search]] in `done/`, and
  ...
  it lands first.
- 9aa16ff: both remaining inline search/stories recipes now point at refs/shortcut-api.md. The + versus --data-urlencode encoding question was deliberately left unresolved rather than guessed.
