...
- 1de2284: test_shortcut_mutation_guard.py added with a BOM-prefixed .env fixture pinning the 2026-08-18 fail-closed bug; unused oldest_fresh_marker import dropped. Suite is now 13 files, all passing.
