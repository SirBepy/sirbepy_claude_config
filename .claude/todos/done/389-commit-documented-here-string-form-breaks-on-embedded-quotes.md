...
- 992feef: root cause ISOLATED in a scratch repo - PowerShell mistokenizes a native git -m argument containing a literal double quote, identically inline and via a variable. The variable-assignment theory in the todo was DISPROVEN. Fix is backslash-escaping the quotes; documented in commit SKILL.md.
