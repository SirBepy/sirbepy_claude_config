...
- 0728458: hooks/write-session-marker.ps1 helper added so a marker either lands at hooks/.session-markers/<id> or errors; call sites fixed. Two real strays confirmed in the tree this morning and removed.
