...
- b427b98: mega-todos injected commit block now opens with the literal staging-line substring the dispatch guard requires, phrased truthfully as the documented exception. Proven live in this run.
