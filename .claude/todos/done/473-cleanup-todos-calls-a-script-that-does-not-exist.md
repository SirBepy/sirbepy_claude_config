...
- Archived stale 2026-08-25: premise disproven. skills/cleanup-todos/update-markers.ps1 exists on disk (4338 bytes, dated 2026-08-12) and SKILL.md references it by bare name from within its own skill directory, which resolves. The 'script does not exist' claim came from looking in skills/close/. No fix needed.
